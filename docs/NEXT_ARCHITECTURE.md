...
`server/persistent-http-mcp-client.mjs` is shared by Figma, DBeaver, Bruno, and the remote Coolify MCP bridge.
...
- 10,592 bytes of `tools/list`, down 88.41%
...
- Figma, DBeaver, Bruno, and Coolify contracts
- fifteen-tool schema and internal action coverage
