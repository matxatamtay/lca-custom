...
const GROUPS = [
  ...
  ["workspace_verify", new Set(["verification_plan", "detect_test_commands", "quality_gate", "run_tests", "run_changed_tests", "run_build", "run_lint", "review_diff", "security_scan", "change_summary", "session_report"])],
  ["workspace_agent", (name) => name.startsWith("agent_")],
  ["workspace_ui", (name) => name.startsWith("ui_")],
  ["workspace_status", new Set(["ping", "workspace_info", "lca", "workspace_doctor", "workspace_snapshot", "project_profile", "profile_status", "reload_profile", "performance_profile", "tool_trace"])],
