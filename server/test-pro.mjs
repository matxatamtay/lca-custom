...
try {
  ...
  check("model-facing surface stays at nineteen tools", toolNames.length === 19, JSON.stringify(toolNames));
  check("coolify facade is listed", toolNames.includes("coolify"), JSON.stringify(toolNames));
